...
object Word_Counter {
  ...
  def main(args: Array[String]): Unit =
  {
    ...
    var hdfs_path = os.path.join(os.sep, fieldemployee, fieldemployee, Scala_Word_Counter.scala)


    var put = Popen(["hadoop", "fs", "-put", Scala_Word_Counter.scala, hdfs_path], stdin=PIPE, bufsize=-1)
